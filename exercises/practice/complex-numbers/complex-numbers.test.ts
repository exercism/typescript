...
describe('Complex numbers', () => {
  ...
  xit('Exponential of a number with real and imaginary part', () => {
    const expected = new ComplexNumber(-2, 0)
    const actual = new ComplexNumber(Math.log(2), Math.PI).exp

    expect(actual.real).toBeCloseTo(expected.real)
    expect(actual.imag).toBeCloseTo(expected.imag)
  })

  xit('Exponential resulting in a number with real and imaginary part', () => {
    const expected = new ComplexNumber(1, 1)
    const actual = new ComplexNumber(Math.log(2) / 2, Math.PI / 4).exp

    expect(actual.real).toBeCloseTo(expected.real)
    expect(actual.imag).toBeCloseTo(expected.imag)
  })

  xit('Add real number to complex number', () => {
  ...
  xit('Add complex number to real number', () => {
    const expected = new ComplexNumber(6, 2)
  ...
  xit('Subtract real number from complex number', () => {
  ...
  xit('Subtract complex number from real number', () => {
    const expected = new ComplexNumber(-1, -7)
  ...
  xit('Multiply complex number by real number', () => {
  ...
  xit('Multiply real number by complex number', () => {
    const expected = new ComplexNumber(10, 25)
  ...
  xit('Divide complex number by real number', () => {
  ...
  xit('Divide real number by complex number', () => {
